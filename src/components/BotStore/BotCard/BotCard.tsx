...
import './style/botcard.scss';
import { BotCardProps } from './IBotCard';
import Rating from '../BS_Rating/index';
import { observer } from 'mobx-react';
import { observable, action } from 'mobx';

@observer
export default class BotCard extends Component<BotCardProps> {
  @observable
  slideIn = ' uk-animation-slide-bottom-medium';
  ...
  getButton() {
    if (this.props.Type.toLowerCase() == 'chat bot') {
      ...
      return (
        <button className="chatButton uk-button uk-flex uk-flex-1  uk-disabled">
          <div className="uk-flex uk-flex-center uk-flex-middle">{this.props.Type}</div>
        </button>
      );
    }
  }
  render() {
    ('renderedBotCard');
    return (
      <div className={'wrapper_botcard uk-overflow-hidden ' + this.slideIn}>
        ...
        <div className="logo uk-flex  uk-flex-center uk-flex-middle " onClick={this.props.ToggleExpand}>
